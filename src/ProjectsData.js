...
export const data = [
  {
    ...
    image: netflix,
    description:
      "A semi functioning Netflix movie application created using React JS and Tailwind CSS - usage of reusable components and state management using useState and useEffect",
    website: "https://netfli-cloning-vitiyah.netlify.app/",
    github: "https://github.com/Vitiyah/netflix-clone.git",
  },
  {
    id: 2,
    title: "Base Apparel",
